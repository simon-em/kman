...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /skills/new", s.newSkill)
	mux.HandleFunc("GET /skills/{name}", s.viewSkill)
	mux.HandleFunc("POST /skills/save", s.saveSkill)
	mux.HandleFunc("POST /skills/fetch-preview", s.fetchSkillPreview)
